...
EditText EInstructions;
    ...
    public void uploadPhoto()
    {
        ...
        progressDialog.setMessage("Loading...Uploading Photo");
        progressDialog.show();
        ...
        storageReference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(Upload.this, "Photo Uploaded Successfully", Toast.LENGTH_SHORT).show();
    ...
    public void uploadRecipe()
    {
        ...
        Recipe recipe=new Recipe(name,ingredients,instructions,photoUrl);
